...
export default function IpoDetailPage() {
  ...
  const { ipoEvents, ipoEntries, ipoAccounts, addIpoEntry, updateIpoEntry, deleteIpoEntry, batchDeleteIpoEntries, batchUpdateIpoEntries, addTrade, showToast, settings, updateIpoEvent, canWrite } = useData();
