...
export const NAV_ITEMS = [
  ...
  { path: '/wealth', label: 'Kekayaan', icon: 'Landmark', section: 'MENU', roles: ['admin', 'mentor', 'trader', 'viewer'] },
  ...
  { path: '/assets', label: 'Aset & Inventaris', icon: 'Archive', section: 'TOOLS', roles: ['admin', 'mentor', 'trader'] },
