# Rangkuman Fitur Baru & Perbaikan (1 Bulan Terakhir)

Berdasarkan riwayat pengerjaan Anda selama satu bulan terakhir, berikut adalah daftar fitur-fitur baru dan peningkatan utama yang telah Anda kerjakan:

### 1. 🚀 Fitur IPO (Initial Public Offering)
- **Ringkasan IPO**: Penambahan fitur untuk melihat ringkasan data IPO.
- **Allotment IPO**: Penambahan informasi penjatahan (allotment) saham IPO.
- **Pembaruan Tampilan**: Mengubah dan memperbarui tema (theme) khusus untuk halaman IPO.
- **Rentang PU (Public Offering)**: Menambahkan informasi atau filter terkait rentang waktu penawaran umum.
...
- **History (Riwayat)**: Fitur untuk melihat riwayat aktivitas atau transaksi.
- **Audit Logs**: Perbaikan pada sistem pencatatan log audit.

### 4. 🎨 Pembaruan Desain (UI/UX) & Sistem Tema
- **Premium Apple-like Design**: Menerapkan sistem desain baru yang lebih premium dengan sudut membulat (rounded), mendukung mode Terang (Light) dan Gelap (Dark).
